...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright MRCAudioPlugins, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/XenTuner-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenTuner-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenTuner-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenTuner-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenTuner-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenTuner-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/XenTuner-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/XenTuner.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/XenTuner.iss",inplace=1):
